...
Game.prototype = {
  ...
  killTank: function (tank) {
    ...
    this.$arena.append(
      '<img id="expl' +
        tank.id +
        '" class="explosion" src="./img/explosion.gif">'
    );
...
Ball.prototype = {
  ...
  explode: function () {
    this.$arena.append(
      '<div id="expl' +
        this.id +
        '" class="ball-explosion" style="left:' +
        this.x +
        'px"></div>'
    );
...
Tank.prototype = {
  materialize: function () {
    this.$arena.append(
      '<div id="' + this.id + '" class="tank tank' + this.type + '"></div>'
    );
    this.$body = $("#" + this.id);
    ...
    this.$body.append(
      '<div id="cannon-' + this.id + '" class="tank-cannon"></div>'
    );
  ...
  setControls: function () {
    ...
    $("body > div.container > div.col-md-3").click(function () {
      inputEnabled = false;
      $("#arena").removeClass("selected");
      $(this).addClass("selected");
    });
    $("#arena").click(function () {
      inputEnabled = true;
      $("body > div.container > div.col-md-3").removeClass("selected");
      $(this).addClass("selected");
    });
  ...
  move: function () {
    ...
    if (
      this.x + moveX > 0 + ARENA_MARGIN &&
      this.x + moveX < this.$arena.width() - ARENA_MARGIN
    ) {
      this.x += moveX;
    }
    if (
      this.y + moveY > 0 + ARENA_MARGIN &&
      this.y + moveY < this.$arena.height() - ARENA_MARGIN
    ) {
      this.y += moveY;
    }
    this.rotateBase();
